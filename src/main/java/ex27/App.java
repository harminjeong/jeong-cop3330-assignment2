...
public class App {
    ...
    public static String validateInput (String first, String last, String zip, String id){
        String first_error = "The first name must be at least 2 characters long.\n ";
        String last_error = "The last name must be at least 2 characters long.\n ";
        String zip_error = "The ZIP code must be a 5 digit number.\n ";
